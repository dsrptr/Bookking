...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (int i=0; i<9; i++) {
            ...
            NSInteger col = i%3;
            // Button Frame
            NSInteger distance = 300/3;
            NSInteger size = distance/1.4;
        ...
        imgView.image=[UIImage imageNamed:@"original@2x"];
//        [imgView setBackgroundColor:[UIColor whiteColor]];
        ...
        changeButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2+30, frame.size.height/2+200, 120, 30)];
        ...
        self.backgroundColor=[ShareAction colorWithHexString:@"303447"];
    }
